...
def generate_risk_report(results, output_path=None):
    ...
    sections.append(f"**生成引擎**：ORCHESTRATOR 报告收束引擎 v2.0\n")
    ...
    sections.append("> ⚠️ 本报告由 AI 多智能体系统（ORCHESTRATOR + Agent-1~5）自动生成，")
    sections.append("> 所有分析结论和修改建议仅供参考，不构成中华人民共和国法律下具有出庭采信效力的正式法律意见。")
    sections.append("> 建议委托持牌律师复核确认后方可采信执行。\n")
    sections.append(f"`Report Generated by: ORCHESTRATOR v2.0 | {now}`\n")
