...
[![Agent v2.1](https://img.shields.io/badge/Agent-v2.1_Multi--Agent-8A2BE2?style=for-the-badge&logo=openai&logoColor=white)](#-v21-orchestrator--5-agent-编排网络benchmark-跑分专版)
...
- [🇨🇳 中文](#-中文)
  ...
  - [各版本架构概览](#-各版本架构概览)
    ...
    - [Agent v2.1 ORCHESTRATOR 编排网络](#tier-4agent-v21-orchestrator--5-agent-编排网络)
...
|:---:|---|
| 🔍 **Risk Recall** | Identify compliance risks and contractual deficiencies in commercial agreements |
| 💰 **EL Precision** | Calculate expected loss margins in alignment with Chinese judicial standards |
| ⚔️ **Plan B Defense** | Draft alternative clauses with litigation-grade defensive utility |
| 📅 **Lifecycle** | Extract lifecycle milestones for corporate fulfillment and compliance monitoring |

<details>
<summary><b>🔽 Click to expand: English Quick Start & Details</b></summary>

#### Highlights

**🎓 Benchmark Edition (v2.1 / 5-Agent + ORCHESTRATOR)**
Automated evaluation pipeline against 25 benchmark cases. Includes Compliance, Risk Quant, Negotiation, Lifecycle, and Deal-Maker Agents. Employs MCP Anti-Hallucination Protocol. ORCHESTRATOR generates 7-chapter structured risk reports with 5-dimension scoring.

**🏢 Enterprise Edition (v2.2 / 6-Agent Pipeline)**
Production-grade template for real-world legal departments. Features Agent-0 Security Pre-Check, contextual input protocols, and verifiable audit trails.
...
#### TIER 4：Agent v2.1 ORCHESTRATOR + 5-Agent 编排网络
...
v2.1 是本项目的**核心测评架构**，采用 ORCHESTRATOR（中央编排器）指挥 5 个专业化 Agent 并发审查，最终由 ORCHESTRATOR 统一收束、质量审计，并输出七章结构化报告。
...
针对真实企业法务部交付场景部署的工作流实体（独立于测评基准运行），在 v2.1 基础上新增了前置安全与审计追溯能力。
...
graph TD
    ...
    ORC -->|"质量审计 + 五维评分"| REPORT["📊 七章结构化<br>风控报告"]
    REPORT --> User
...
│   ├── senior-legal-contract-reviewer-v2/    # v2.1 多 Agent 编排 (Benchmark)
│   └── senior-legal-contract-reviewer-v2.2-enterprise/  # v2.2 企业生产版
│
